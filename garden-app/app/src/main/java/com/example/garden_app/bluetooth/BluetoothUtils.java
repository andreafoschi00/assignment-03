...
public class BluetoothUtils {
    ...
    public static BluetoothDevice getPairedDeviceByName(final String deviceName)
            throws com.example.garden_app.bluetooth.exceptions.BluetoothDeviceNotFound {
        ...
        throw new com.example.garden_app.bluetooth.exceptions.BluetoothDeviceNotFound();
    }
